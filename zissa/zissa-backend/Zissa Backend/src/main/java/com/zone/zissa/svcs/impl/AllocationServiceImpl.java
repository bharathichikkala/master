        ...
        if (resourceExists != null) {
            ...
            if (permissionExists) {
                ...
                if (allocationList.isEmpty()) {
                    ...
                    throw new NoContentException(RestAPIMessageConstants.GETTING_ALLOCATION_HISTORY_FAILURE,
                            "No Allocation History available for the given Resource");
                }
            } else {
                throw new AccessDeniedException(RestAPIMessageConstants.ACCESS_DENIED, "Error in accessing data");
            }
        } else {
            throw new NotFoundException(RestAPIMessageConstants.GETTING_ALLOCATION_HISTORY_FAILURE,
                    "Resource not Exists");
        }

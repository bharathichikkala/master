...
public class UserServiceImpl implements UserService {
    ...
    public User addUser(String userData) throws JSONException {
        ...
        if (userExists == null) {
            ...
            throw new ConflictException("Failed in User Creation", "User Already Exists");
        }
        return userObject;
    }
    ...
    public User updateUser(String userData) throws JSONException {
        ...
        if (userExists == null) {
            throw new DataNotFoundException("User updated successful", "User updated");
        } else {
            user.setUserName(userName);
            user.setEmail(email);
            user.setFirstName(firstName);
    ...
    public ServiceResponse deleteUser(Integer userID) {
        ...
        if (userExists != null) {
            ...
            throw new DataNotFoundException("User deleted successful", "User deleted");

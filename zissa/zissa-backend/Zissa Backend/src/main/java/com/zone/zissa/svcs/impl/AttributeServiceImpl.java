...
public class AttributeServiceImpl implements AttributeService {
    ...
    public Attribute addAttribute(String attributeData) throws JSONException {
        ...
        if (attributeExists == null) {
            ...
            throw new ConflictException("Failed in Attribute Creation", "Attribute Already Exits");
        }
    ...
    public Attribute updateAttribute(String attributeData) throws JSONException {
        ...
        if (attributeObject == null) {
            throw new DataNotFoundException("Updated Attribute successfully", "Attribute updated successfully");

        } else {
            if (attributeRepo.findByName(name) != null
                    && attributeRepo.findByName(name).getAttribute_ID() != attributeId) {
                throw new ConflictException(RestAPIMessageConstants.ATTR_UPDATION_FAILURE,
        ...
        if (dropDownValue == 1) {
            ...
            for (int i = 0; i < jsonChildObject.length(); i++) {
                ...
                attributeValueObject.setAttributeValueID(json.getInt("attribute_Value_ID"));
    ...
    public Attribute checkDeleteAttributeFailureListIsNotEmpty(List<String> deleteAttributeFailureList,
        ...
        if (!deleteAttributeFailureList.isEmpty()) {
            throw new ConflictException(RestAPIMessageConstants.ATTR_UPDATION_FAILURE,
                    "Attribute values " + deleteAttributeFailureList + " is already in use");
        } else {
    ...
    public List<String> deleteAttributeMethod(JSONArray jsonDeleteAttributeObject, Short attributeId)
        ...
        for (int i = 0; i < jsonDeleteAttributeObject.length(); i++) {
            ...
            int attributeValueId = jsonObject.getInt("attribute_Value_ID");
            AttributeValue attributeValueObject = attributeValueRepo.findByAttributeValueID(attributeValueId);
            ...
            if (resourceAttributeList.isEmpty() && resourceBinAttributeList.isEmpty()) {
                attributeValueRepo.deleteAttributeValueID(attributeValueId);
            } else {
    ...
    public void deleteAttribute(Short attributeId) {
        ...
        if (attributeExists != null) {
            ...
            throw new DataNotFoundException("Attribute is deleted successfully", "Attribute deleted");

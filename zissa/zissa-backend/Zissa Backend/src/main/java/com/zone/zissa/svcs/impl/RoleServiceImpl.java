...
public class RoleServiceImpl implements RoleService {
    ...
    public Role addRole(String roleData) throws JSONException {
        ...
        if (roleExists == null) {
            ...
            throw new ConflictException("Failed in Role Creation", "Role Already Exits");
        }
        return roleObject;
    }
    ...
    public Role getAllPermissionsByRole(Integer roleId) {
        ...
        if (roleObject != null) {
            ...
            throw new NotFoundException("Failed in getting Role Permission Details",
                    RestAPIMessageConstants.ROLE_EXISTS_FAILURE);
        }
        return roleObject;
    }
    ...
    public Role updateRole(String roleData) throws JSONException {
        ...
        Role roleObject = null;
        if (roleExists == null) {
            throw new DataNotFoundException("Role updated successfully", "Role updated");

        } else {
            if (roleRepo.findByName(name) != null && roleRepo.findByName(name).getRole_ID() != roleId) {
                throw new ConflictException(RestAPIMessageConstants.ROLE_UPDATION_FAILURE, "Role Name Already Exists");
            } else {
                roleObject = roleRepo.save(role);
            }
        }
    ...
    public void deleteRole(Integer roleId) {
        ...
        if (roleExists != null) {
            ...
            throw new DataNotFoundException("Role deleted successful", "Role deleted");
    ...
    public List<Permission> getAllPermissionsByRoleAndCategory(Integer roleId, Integer categoryId) {
        ...
        if (categoryExists != null) {
            ...
            if (permissionObject.isEmpty()) {
                throw new NoContentException("Failed in getting Permission Details",
                        "No Permissions available for the given category and Role");
            }
        } else {
            throw new NotFoundException("Failed in getting Permission Details",

...
public class CategoryServiceImpl implements CategoryService {
    ...
    public Category addCategory(String categoryData) throws JSONException {
        ...
        if (patternExists != null) {
            ...
            throw new ConflictException(RestAPIMessageConstants.CAT_CREATION_FAILURE, "Code Pattern Already Exists");
        }
        if (categoryExists == null) {
            ...
            throw new ConflictException(RestAPIMessageConstants.CAT_CREATION_FAILURE, "Category Already Exits");
        }
    ...
    public List<CategoryAttribute> getCategoryAttributesByCategoryId(Integer categoryID) {
        ...
        for (CategoryAttribute categoryAttribute : categoryAttributeList) {
            ...
            Collections.sort(list, new Comparator<AttributeValue>() {
                ...
                public int compare(AttributeValue o1, AttributeValue o2) {
                    ...
                    return Integer.valueOf(o1.getAttribute_Value_ID())
        ...
        if (categoryExists == null) {
            throw new NotFoundException(RestAPIMessageConstants.CATATTR_RETREIVE_FAILURE,
                    RestAPIMessageConstants.CAT_EXISTS_FAILURE);
        }
        if (categoryAttributeList.isEmpty()) {
            throw new NoContentException(RestAPIMessageConstants.CATATTR_RETREIVE_FAILURE,
    ...
    public Category updateCategory(String categoryData) throws JSONException {
        ...
        if (categoryObject == null) {
            throw new DataNotFoundException("Category updated successfully", "Category updated");

        } else {
            if (categoryRepo.findByName(name) != null && categoryRepo.findByName(name).getCategory_ID() != categoryId) {
                throw new ConflictException(RestAPIMessageConstants.CAT_UPDATION_FAILURE,
     ...
     * 
     * @param resourcelist
     * @param categoryattrobj
     * @param attributeobj1
     */
    public void insertResourceAttrMethod(List<Resource> resourceList, CategoryAttribute categoryattrobj,
            Attribute attributeObject) {
        for (int j = 0; j < resourceList.size(); j++) {
            ResourceAttribute resourceAttributeObject = new ResourceAttribute();
            if (attributeObject.getAttrDataType().getData_Type_ID() == 2
                    || attributeObject.getAttrDataType().getData_Type_ID() == 3
                    || attributeObject.getAttrDataType().getData_Type_ID() == 4) {
                resourceAttributeObject.setValue("0");
            } else {
                resourceAttributeObject.setValue("");
            }
            resourceAttributeObject.setAttribute(categoryattrobj.getAttribute());
     ...
     * @param attributeobj1
     */
    public void insertReourceBinAttrMethod(List<Resourcebin> resourcebinList, CategoryAttribute categoryattrobj,
            Attribute attributeObject) {
        for (int j = 0; j < resourcebinList.size(); j++) {
            ...
            resourcebinAttributeObject.setAttribute(categoryattrobj.getAttribute());
    ...
    public ServiceResponse deleteCategory(Integer categoryID) {
        ...
        if (categoryExists != null) {
            ...
            throw new DataNotFoundException("Category deleted successfully", "Category deleted");
    ...
    public List<CategoryAttribute> getCategoryAttributesByCategoryIdList(List<Category> categoryId) {
        ...
        if (categoryAttributeList.isEmpty()) {
            throw new NoContentException("Failed in getting Category related Attributes",
                    "No attributes available for given categories");
        }
        return categoryAttributeList;
    }
}

...
public class ResourceMgmtControllerTest extends ZissaApplicationTest {
    ...
    @Transactional
    @WithMockUser(username = username, password = password)
    public void addResourceFailureTest_2() throws Exception {
    ...
    public void updateResourceFailureTest1() throws Exception {
        JSONObject updateResourceData = new JSONObject();
    ...
    @Test
    @WithMockUser(username = f_Username, password = f_Password)
    public void deleteResourceFailureTest1() throws Exception {
    ...
    @Test
    @WithMockUser(username = username, password = password)
    public void deleteResourceFailureTest12() throws Exception {
    ...
    @Transactional
    @WithMockUser(username = username, password = password)
    public void disposeResourcesFailureTest1() throws Exception {
        JSONArray array = new JSONArray();
    ...
    @Transactional
    @WithMockUser(username = username, password = password)
    public void disposeResourcesFailureTest2() throws Exception {
    ...
    @Transactional
    @WithMockUser(username = f_Username, password = f_Password)
    public void restoreResourcesFailureTest1() throws Exception {
    ...
    @Transactional
    @WithMockUser(username = username, password = password)
    public void resourceAllocationTest1() throws Exception {
    ...
    @Transactional
    @WithMockUser(username = f_Username, password = f_Password)
    public void resourceAllocationFailureTest_1() throws Exception {
    ...
    @Transactional
    @WithMockUser(username = username, password = password)
    public void resourceAllocationFailureTest_2() throws Exception {

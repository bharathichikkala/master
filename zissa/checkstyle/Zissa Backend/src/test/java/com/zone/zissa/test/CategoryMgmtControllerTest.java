...
public class CategoryMgmtControllerTest extends ZissaApplicationTest {
  ...
  /**
   * Junit test case for getCategoryAttributesByCategoryId @PathParam category_ID.
   *
  ...
  public void getCategoryAttributeByIdTest() throws Exception {
    ...
    this.mockMvc
        .perform(get("/v1/categories/{category_ID}/attributes", +category_ID))
  ...
  /**
   * Junit Failure test case for getCategoryAttributesByCategoryId by invalid id @PathParam
   * category_ID.
   *
  ...
  public void getCategoryAttributesByInvalidIdTest() throws Exception {
    Integer id = 879;
    this.mockMvc.perform(get("/v1/categories/{id}/attributes", +id))
        .andExpect(status().isOk())
        .andExpect(content().contentType("application/json;charset=UTF-8"))
  ...
  /**
   * Junit Failure test case for getCategoryAttributesByCategoryId @PathParam category_ID.
   *
  ...
  public void getCategoryAttributesByCategoryIdListTest() throws Exception {
    ...
    this.mockMvc
        .perform((get("/v1/categories/attributes")).param("category_ID", "1"))
        .andExpect(status().isOk())
        .andExpect(content().contentType("application/json;charset=UTF-8"))
        .andExpect(jsonPath("$.data").exists())
        .andExpect(jsonPath("$.status").value(200));
  ...
  /**
   * Junit failure test case for getCategoryAttributesByCategoryIdList by invalid category_ID.
   *
  ...
  public void getCategoryAttributesByCategoryIdListFailureTest()
    ...
    this.mockMvc
        .perform((get("/v1/categories/attributes")).param("category_ID", "00"))
        .andExpect(status().isOk())
        .andExpect(content().contentType("application/json;charset=UTF-8"))
        .andExpect(jsonPath("$.status").value(204));
  }
  ...
  public void getAllOperationsTest() throws Exception {
    ...
    this.mockMvc.perform(get("/v1/categories/operations"))
        .andExpect(status().isOk())
        .andExpect(content().contentType("application/json;charset=UTF-8"))
        .andExpect(jsonPath("$.data").exists())
        .andExpect(jsonPath("$.status").value(200));
  ...
  /**
   * Junit test case for deleteCategory @PathParam category_ID.
   *
   * @throws Exception the exception
   */
  @Test
  ...
  public void deleteCategoryTest() throws Exception {
    int id = 3;
    this.mockMvc.perform(delete("/v1/categories/{category_ID}", id))
        .andExpect(status().isOk())
        .andExpect(content().contentType("application/json;charset=UTF-8"))
        .andExpect(jsonPath("$.status").value(200));
  }
  ...
  /**
   * Junit Failure test case for deleteCategory @PathParam category_ID.
   *
   * @throws Exception the exception
   */
  @Test
  ...
  /**
   * Junit test case for deleteCategory by deleting Foriegn key relation @PathParam category_ID.
   *
   * @throws Exception the exception
   */
  @Test
  ...
  public void addCategoryTest() throws Exception {
    ...
    this.mockMvc
        .perform(
            post("/v1/categories").contentType("application/json;charset=UTF-8")

...
public class RoleMgmtControllerTest extends ZissaApplicationTest {
  ...
  /**
   * Junit test case for deleteRole @PathParam role_ID.
   *
   * @throws Exception the exception
   */
  @Test
  ...
  public void deleteRoleTest() throws Exception {
    ...
    this.mockMvc.perform(delete("/v1/roles/{role_ID}", id))
        .andExpect(status().isOk())
        .andExpect(content().contentType("application/json;charset=UTF-8"))
        .andExpect(jsonPath("$.status").value(200));
  }
  ...
  /**
   * Junit Failure test case using invalid ID for deleteRole @PathParam role_ID.
   *
   * @throws Exception the exception
   */
  @Test
  ...
  /**
   * Junit test case for deleteRole by deleting Foriegn key relation @PathParam role_ID.
   *
   * @throws Exception the exception
   */
  @Test
  ...
  /**
   * Junit test case for getAllPermissionsByRole @PathParam role_ID.
   *
  ...
  public void getAllPermissionsByRoleTest() throws Exception {
    int id = 1;
    this.mockMvc.perform(get("/v1/roles/{id}/permissions/", id))
        .andExpect(status().isOk())
        .andExpect(content().contentType("application/json;charset=UTF-8"))
        .andExpect(jsonPath("$.status").value(200));
  }
  ...
  /**
   * Junit Failure test case for getAllPermissionsByRole @PathParam role_ID.
   *

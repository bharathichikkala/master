...
public class AttributeMgmtControllerTest extends ZissaApplicationTest {
  ...
  public void getAllAttributeDataTypesTest() throws Exception {
    ...
    this.mockMvc.perform(get("/v1/attributes/attributeDataTypes"))
  ...
  /**
   * Junit test case for getAttributeInfoById @PathParam attribute_ID.
   *
  ...
  /**
   * Junit Failure test case for getAttributeInfoById invalid attribute_ID @PathParam attribute_ID.
   *
   * @return the attribute info by id failure test
   * @throws Exception the exception
   */
  @Test
  @Transactional
  ...
  public void addAttributeTest() throws Exception {
    ...
    this.mockMvc
        .perform(
            post("/v1/attributes").contentType("application/json;charset=UTF-8")
  ...
  public void updateAttributeTest() throws Exception {
    ...
    this.mockMvc
        .perform(
            put("/v1/attributes").contentType("application/json;charset=UTF-8")
  ...
  /**
   * Junit test case for deleteAttribute @PathParam attribute_ID.
   *
   * @throws Exception the exception
   */
  @Test
  ...
  public void deleteAttributeTest() throws Exception {
    ...
    this.mockMvc.perform(delete("/v1/attributes/{attribute_ID}", id))
        .andExpect(status().isOk())
        .andExpect(content().contentType("application/json;charset=UTF-8"))
        .andExpect(jsonPath("$.status").value(200));
  }
  ...
  /**
   * Junit Failure test case using unavailable ID for deleteAttribute @PathParam attribute_ID.
   *
   * @throws Exception the exception
   */
  @Test
  ...
  /**
   * Junit test case for deleteAttribute by deleting Foriegn key relation @PathParam attribute_ID.
   *
   * @throws Exception the exception
   */
  @Test

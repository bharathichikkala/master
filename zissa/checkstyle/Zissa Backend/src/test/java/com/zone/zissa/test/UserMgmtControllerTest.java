...
public class UserMgmtControllerTest extends ZissaApplicationTest {
  ...
  /**
   * Junit test case for deleteUser @PathParam user_ID.
   *
   * @throws Exception the exception
   */
  @Test
  ...
  public void deleteUserTest() throws Exception {
    ...
    this.mockMvc.perform(delete("/v1/users/{user_ID}", 3))
        .andExpect(status().isOk())
        .andExpect(content().contentType("application/json;charset=UTF-8"))
        .andExpect(jsonPath("$.status").value(200));
  }
  ...
  /**
   * Junit Failure test case for deleteUser By Invalid user_ID @PathParam user_ID.
   *
   * @throws Exception the exception
   */
  @Test
  ...
  public void deleteUserFailureTest() throws Exception {
    int id = 000;
    this.mockMvc.perform(delete("/v1/users/{user_ID}", id))
        .andExpect(status().isOk())
        .andExpect(content().contentType("application/json;charset=UTF-8"))
        .andExpect(jsonPath("$.status").value(200));
  }
  ...
  /**
   * Junit test case for deleteUser by deleting Foriegn key relation @PathParam user_ID.
   *
   * @throws Exception the exception
   */
  @Test
  ...
  public void deleteUserFailureTestByForiegnKey() throws Exception {
    ...
    this.mockMvc.perform(delete("/v1/users/{user_ID}", 1))
        .andExpect(status().isOk())
        .andExpect(content().contentType("application/json;charset=UTF-8"))
        .andExpect(jsonPath("$.status").value(409));
  }

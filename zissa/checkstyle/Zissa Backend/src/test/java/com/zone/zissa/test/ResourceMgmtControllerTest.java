...
public class ResourceMgmtControllerTest extends ZissaApplicationTest {
  ...
  public void addResourceFailureTest() throws Exception {
    ...
    this.mockMvc
        .perform(
            post("/v1/resources").contentType("application/json;charset=UTF-8")
                .content(TestUtil.convertObjectToJsonString(addResourceData)))
  ...
  public void updateResourceTest() throws Exception {
    ...
    this.mockMvc
        .perform(
            put("/v1/resources").contentType("application/json;charset=UTF-8")
  ...
  public void deleteResourceTest() throws Exception {
    ...
    this.mockMvc.perform(delete("/v1/resources/{resource_ID}", 1))
        .andExpect(status().isOk())
        .andExpect(content().contentType("application/json;charset=UTF-8"))
        .andExpect(jsonPath("$.status").value(200));
  }
  ...
  public void deleteResourceFailureTest() throws Exception {
    ...
    this.mockMvc.perform(delete("/v1/resources/{resource_ID}", 10))
        .andExpect(status().isOk())
        .andExpect(content().contentType("application/json;charset=UTF-8"))
        .andExpect(jsonPath("$.status").value(200));
  }
  ...
  public void deleteResourceByAllocatedResourceTest() throws Exception {
    ...
    this.mockMvc.perform(delete("/v1/resources/{resource_ID}", 7))
        .andExpect(status().isOk())
        .andExpect(content().contentType("application/json;charset=UTF-8"))
        .andExpect(jsonPath("$.status").value(409));
  }
  ...
  public void disposeResourcesTest() throws Exception {
    ...
    this.mockMvc
        .perform(delete("/v1/resources/dispose")
  ...
  public void restoreResourcesTest() throws Exception {
    ...
    this.mockMvc.perform(delete("/v1/resources/restore?resource_ID=1"))
        .andExpect(status().isOk())
        .andExpect(content().contentType("application/json;charset=UTF-8"))
        .andExpect(jsonPath("$.status").value(200));
  }
  ...
  public void restoreResourcesFailureTest() throws Exception {
    ...
    this.mockMvc.perform(delete("/v1/resources/restore?resource_ID=10,11"))
        .andExpect(status().isOk())
        .andExpect(content().contentType("application/json;charset=UTF-8"))
        .andExpect(jsonPath("$.status").value(500));
  }
  ...
  /**
   * Junit test case for getLastResourceByCategory @PathParam categoryID.
   *
  ...
  public void getLastResourceByCategoryTest() throws Exception {
    int categoryID = 1;
    this.mockMvc
        .perform(get("/v1/resources/lastresource/{categoryID}", categoryID))
        .andExpect(status().isOk())
        .andExpect(content().contentType("application/json;charset=UTF-8"))
  ...
  /**
   * Junit failure test case for getLastResourceByCategory @PathParam categoryID.
   *
  ...
  /**
   * Junit test case for getDisposedResourcesByCategoryId @PathParam categoryID.
   *
  ...
  public void getDisposedResourcesByCategoryIdTest() throws Exception {
    int categoryID = 1;
    this.mockMvc.perform(get("/v1/resources/disposed/{categoryID}", categoryID))
        .andExpect(status().isOk())
        .andExpect(content().contentType("application/json;charset=UTF-8"))
        .andExpect(jsonPath("$.status").value(200));
  }
  ...
  /**
   * Junit failure test case for getDisposedResourcesByCategoryId by invalid category_ID @PathParam
   * categoryID.
   *
  ...
  /**
   * Junit failure test case for getDisposedResourcesByCategoryId by invalid data @PathParam
   * categoryID.
   *
   * @return the disposed resources by category id test by invalid data
   * @throws Exception the exception
   */
  @Test
  @Transactional
  public void getDisposedResourcesByCategoryIdTestByInvalidData()
      throws Exception {
    int categoryID = 1;
    this.mockMvc.perform(get("/v1/resources/disposed/{categoryID}", categoryID))
        .andExpect(status().isOk())
  ...
  /**
   * Junit failure test case for getDisposedResourcesByCategoryId for Access denied @PathParam
   * categoryID.
   *
  ...
  /**
   * Junit test case for getDisposedResource @PathParam resource_ID.
   *
  ...
  public void getDisposedResourceTest() throws Exception {
    int id = 1;
    this.mockMvc.perform(get("/v1/resources/disposedobj/{resource_ID}", id))
        .andExpect(status().isOk())
        .andExpect(content().contentType("application/json;charset=UTF-8"))
        .andExpect(jsonPath("$.status").value(200));
  }
   ...
   *
   * @return the disposed resource failure test by invalid data
   * @throws Exception the exception
   */
  @Test
  @Transactional
  ...
  /**
   * Junit test case for getResourcesbyResourceIdList by sending list of resource_ID.
   *
  ...
  public void getResourcesbyResourceIdListTest() throws Exception {
    ...
    this.mockMvc.perform(get("/v1/resources/resourceobj?resource_ID=1,2"))
        .andExpect(status().isOk())
        .andExpect(content().contentType("application/json;charset=UTF-8"))
        .andExpect(jsonPath("$.data").exists())
        .andExpect(jsonPath("$.status").value(200));
  ...
  /**
   * Junit test case for getResourcesbyResourceIdList by sending list of invalid resource_ID.
   *
  ...
  public void getResourcesbyResourceIdListFailureTest() throws Exception {
    ...
    this.mockMvc.perform(get("/v1/resources/resourceobj?resource_ID=000,1000"))
        .andExpect(status().isOk())
        .andExpect(content().contentType("application/json;charset=UTF-8"))
        .andExpect(jsonPath("$.status").value(404));
  }
  ...
  public void getAllResourcesByCategoryIdTest() throws Exception {
    int id = 1;
    this.mockMvc.perform(get("/v1/resources/{category_ID}", id))
        .andExpect(status().isOk())
        .andExpect(content().contentType("application/json;charset=UTF-8"))
        .andExpect(jsonPath("$.data").exists())
        .andExpect(jsonPath("$.status").value(200));
   ...
   *
   * @return the all resources by category id failure test by invalid data
   * @throws Exception the exception
   */
  @Test
  @Transactional
  public void getAllResourcesByCategoryIdFailureTestByInvalidData()
      throws Exception {
    int id = 1;
    this.mockMvc.perform(get("/v1/resources/{category_ID}", id))
        .andExpect(status().isOk())
  ...
  public void getResourcesBySearchTermTest() throws Exception {
    ...
    this.mockMvc
        .perform(get("/v1/resources").param("category_ID", category)
            .param("page", page).param("size", size)
            .param("searchText", searchText).param("direction", direction)
   ...
   *
   * @return the resources by search term failure test
   * @throws Exception the exception
   */
  @Test
  @Transactional
  ...
  public void getDisposedResourcesBySearchTermTest() throws Exception {
    ...
    this.mockMvc
        .perform(get("/v1/resources/disposed").param("category_ID", category)
            .param("page", page).param("size", size)
            .param("searchText", searchText).param("direction", direction)
            .param("attrid", attribute))
        .andExpect(status().isOk())
   ...
   *
   * @return the disposed resources by search term failure test
   * @throws Exception the exception
   */
  @Test
  @Transactional
  ...
  public void getResourceTest() throws Exception {
    int id = 1;
    this.mockMvc.perform(get("/v1/resources/resourceobj/{resource_ID}", id))
        .andExpect(status().isOk())
        .andExpect(content().contentType("application/json;charset=UTF-8"))
        .andExpect(jsonPath("$.status").value(200));
  }
   ...
   *
   * @return the resource failure test invalid data
   * @throws Exception the exception
   */
  @Test
  @Transactional
  ...
  public void resourceAllocationTest() throws Exception {
    ...
    this.mockMvc
        .perform(post("/v1/resources/allocations")
            .content(TestUtil.convertObjectToJsonString(array)))
        .andExpect(status().isOk())
        .andExpect(content().contentType("application/json;charset=UTF-8"))
        .andExpect(jsonPath("$.status").value(200));
  ...
  /**
   * Junit failure test case for resourceAllocation for bad request - invalid resourceId.
   *
   * @throws Exception the exception
   */
  @Test
  ...
  public void resourceAllocationFailureTestByInvalidId() throws Exception {
    ...
    this.mockMvc
        .perform(post("/v1/resources/allocations")
            .content(TestUtil.convertObjectToJsonString(obj)))
        .andExpect(status().isOk())
        .andExpect(content().contentType("application/json;charset=UTF-8"))
  ...
  public void getAllCategoriesWithViewPermissionsTest() throws Exception {
    ...
    this.mockMvc.perform(get("/v1/resources/viewpermissions"))
        .andExpect(status().isOk())
        .andExpect(content().contentType("application/json;charset=UTF-8"))
        .andExpect(jsonPath("$.data").exists())
        .andExpect(jsonPath("$.status").value(200));
  ...
  public void getAllCategoriesWithAddPermissionsTest() throws Exception {
    ...
    this.mockMvc.perform(get("/v1/resources/addpermissions"))
        .andExpect(status().isOk())
        .andExpect(content().contentType("application/json;charset=UTF-8"))
        .andExpect(jsonPath("$.data").exists())
        .andExpect(jsonPath("$.status").value(200));
  ...
  public void getAllCategoriesWithDisposePermissionsTest() throws Exception {
    ...
    this.mockMvc.perform(get("/v1/resources/disposepermissions"))
        .andExpect(status().isOk())
        .andExpect(content().contentType("application/json;charset=UTF-8"))
        .andExpect(jsonPath("$.data").exists())
        .andExpect(jsonPath("$.status").value(200));
  ...
  public void getAllCategoriesWithAllocatePermissionsTest() throws Exception {
    ...
    this.mockMvc.perform(get("/v1/resources/allocatepermissions"))
        .andExpect(status().isOk())
        .andExpect(content().contentType("application/json;charset=UTF-8"))
        .andExpect(jsonPath("$.data").exists())
        .andExpect(jsonPath("$.status").value(200));
  ...
  public void getAllPermissionsByRoleAndCategoryTest() throws Exception {
    ...
    this.mockMvc
        .perform(get("/v1/resources/permissions?role_ID=1&category_ID=1"))
        .andExpect(status().isOk())
        .andExpect(content().contentType("application/json;charset=UTF-8"))
        .andExpect(jsonPath("$.data").exists())
        .andExpect(jsonPath("$.status").value(200));
  ...
  /**
   * Junit Failure test case for getAllPermissionsByRoleAndCategory without permissions.
   *
  ...
  public void getAllPermissionsByRoleAndCategoryFailureTest() throws Exception {
    ...
    this.mockMvc
        .perform(get("/v1/resources/permissions?role_ID=3&category_ID=1"))
        .andExpect(status().isOk())
        .andExpect(content().contentType("application/json;charset=UTF-8"))
  ...
  /**
   * Junit Failure test case for getAllPermissionsByRoleAndCategory for unavailable category.
   *
  ...
  public void getAllPermissionsByRoleAndCategoryFailureByUnavailableCategoryTest()
    ...
    this.mockMvc
        .perform(get("/v1/resources/permissions?role_ID=1&category_ID=15"))
        .andExpect(status().isOk())
        .andExpect(content().contentType("application/json;charset=UTF-8"))
        .andExpect(jsonPath("$.status").value(404));
  }

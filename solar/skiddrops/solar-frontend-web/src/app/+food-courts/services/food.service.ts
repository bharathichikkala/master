...
export class FoodService {
  ...
  public addFoodStation(object) {
    let foodAddURL = endponitConfig.FOOD_API_ENDPOINT + 'addfoodcourt'
    let url = `${foodAddURL}`;
    return this.http
  ...
  public updateFoodStation(object) {
    let foodAddURL = endponitConfig.FOOD_API_ENDPOINT + 'updatefoodcourt'
    let url = `${foodAddURL}`;
    return this.http
  ...
  public getFoodAdressById(id) {
    let getDriversURL = endponitConfig.FOOD_API_ENDPOINT + id

...
export class DamageComponent {
    ...
    cartonQr: any;
    loadNumber: any;
    constructor(private router: Router, private fb: FormBuilder, private _sanitizer: DomSanitizer, private route: ActivatedRoute, private inspectionService: DestinationInspectionServices) {
    ...
    validateException() {
        ...
        this.inspectionService.inspectionCartonByScan(obj).subscribe((data) => {
            ...
            this.popupRoute = "./post-inspection/inspectionDetails/" + localStorage.getItem('skiddropInspectionLocNum');
            this.popup.click();
        })
    }
    submit() {

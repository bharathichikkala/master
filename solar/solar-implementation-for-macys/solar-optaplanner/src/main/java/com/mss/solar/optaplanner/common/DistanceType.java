...
public enum DistanceType {
	AIR_DISTANCE, ROAD_DISTANCE_KM, ROAD_DISTANCE_TIME, SEGMENTED_ROAD_DISTANCE_KM, SEGMENTED_ROAD_DISTANCE_TIME;
	...
	public String getFileSuffix() {
		...
		default:
			throw new IllegalStateException("The generationDistanceType (" + this + ") is not implemented.");
	...
	/*public double extractDistance(PathWrapper path) {
		switch (this) {
		case AIR_DISTANCE:
			throw new IllegalStateException("The generationDistanceType (" + this + ") does not support GHResponse.");
		case ROAD_DISTANCE_KM:
		case SEGMENTED_ROAD_DISTANCE_KM:
	...
	public String getUnitOfMeasurement() {
		switch (this) {
		case AIR_DISTANCE:
			throw new IllegalStateException("The generationDistanceType (" + this + ") does unit of measurement.");
		case ROAD_DISTANCE_KM:
		case SEGMENTED_ROAD_DISTANCE_KM:
			return "km";
		case ROAD_DISTANCE_TIME:

...
export class SkidServices {
    ...
    getLoadDetailsBesedOnMiles(loadNumber) {
        return this.http.get(endponitConfig.LOAD_API + 'getDriverAcceptedLoadDetails/' + loadNumber, { headers: this.headers })
    ...
    getSkidsByloadNumber(loadNumber) {
        return this.http.get(endponitConfig.SOLAR_LOAD_ENDPOINT + 'loadAppointments/skidDropsByLoadNumber/' + loadNumber, { headers: this.headers })

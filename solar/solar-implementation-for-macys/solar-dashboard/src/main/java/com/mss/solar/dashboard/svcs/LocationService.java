...
/*	@GetMapping(RestApiUrlConstants.GET_DISTANCE_AND_TIME_BY_SKID)
	@ResponseBody
	ServiceResponse<String> getDistanceAndTimeBasedOnskid(@NotNull @PathVariable Long driverId,@NotNull @PathVariable Long skidId);*/
	
	@GetMapping(value = RestApiUrlConstants.GET_DISTANCE)
	@ResponseBody
	Double getDistance(@PathVariable("sourcelat") double sourcelat,
			@PathVariable("sourcelong") double sourcelong, @PathVariable("destlat") double destlat,
			@PathVariable("destlong") double destlong);
	
	@GetMapping(value = RestApiUrlConstants.GET_DISTANCE_BY_RADIAN)
	@ResponseBody
	Double getDistanceByRadian(@PathVariable("sourcelat") Double sourcelat,
	@PathVariable("sourcelong") Double sourcelong, @PathVariable("destlat") Double destlat,
	@PathVariable("destlong") Double destlong);

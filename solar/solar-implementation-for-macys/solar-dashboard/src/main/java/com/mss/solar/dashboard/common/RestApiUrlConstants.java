...
public class RestApiUrlConstants {
	...
	/**
	 * VEHICLEROUTING MODULE
	 */
	
	public static final String VEHICLE_ROUTING_BY_LOADNUMBER = "/routing/{loadNumber}";
	
	public static final String GENERATE_VRP_FILE = "/generatevrp/{loadNumber}";

...
@Entity
@Table(name = "busyreturnreport")
public class BusyReturnReport {

	@Id
	@GeneratedValue(strategy = GenerationType.AUTO)
	private Long id;

	private String bs1Percent;

	private String originalSalePurcVchNo;

	private LocalDate originalSalePurcDate;
	...
	public String getOriginalSalePurcVchNo() {
		return originalSalePurcVchNo;
	}

	public LocalDate getOriginalSalePurcDate() {
		return originalSalePurcDate;
	}
	...
	public void setBs1Percent(String bs1Percent) {
	...
	public void setOriginalSalePurcVchNo(String originalSalePurcVchNo) {
		this.originalSalePurcVchNo = originalSalePurcVchNo;
	}

	public void setOriginalSalePurcDate(LocalDate originalSalePurcDate) {
		this.originalSalePurcDate = originalSalePurcDate;
	}

...
@Entity
@Table(name = "amazonflipkartshipments")
public class AmazonFlipkartShipments {
	@Id
	...
	private String zohocreatedDate;
	...
	public String getZohocreatedDate() {
		return zohocreatedDate;
	}

	public void setZohocreatedDate(String zohocreatedDate) {

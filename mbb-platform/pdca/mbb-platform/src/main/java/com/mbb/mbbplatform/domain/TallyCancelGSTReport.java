...
@Entity
@Table(name = "tallycancelgstreport")
public class TallyCancelGSTReport {
	@Id
	...
	private LocalDate dispatchDateOrcancellationDate;
	...
	private String channelInvoiceCreated;
	...
	public String getDiscountLedger() {
		return discountLedger;
	}

	public void setDiscountLedger(String discountLedger) {
	...
	public LocalDate getDispatchDateOrcancellationDate() {
		return dispatchDateOrcancellationDate;
	}

	public void setDispatchDateOrcancellationDate(LocalDate dispatchDateOrcancellationDate) {
	...
	public String getChannelInvoiceCreated() {
		return channelInvoiceCreated;
	}

	public void setChannelInvoiceCreated(String channelInvoiceCreated) {

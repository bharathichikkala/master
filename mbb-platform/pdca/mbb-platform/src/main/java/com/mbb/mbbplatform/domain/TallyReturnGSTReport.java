...
@Entity
@Table(name = "tallyreturnsgstreport")
public class TallyReturnGSTReport {
	@Id
	...
	private LocalDate invoiceChannelCreated;
	...
	public LocalDate getInvoiceChannelCreated() {
		return invoiceChannelCreated;
	}

	public void setInvoiceChannelCreated(LocalDate invoiceChannelCreated) {

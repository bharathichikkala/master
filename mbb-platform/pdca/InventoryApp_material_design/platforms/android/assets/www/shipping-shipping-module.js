...
/***/ "./src/app/+product-management/shipping/shipping.component.html":
/*!**********************************************************************!*\
  !*** ./src/app/+product-management/shipping/shipping.component.html ***!
  \**********************************************************************/
...
module.exports = "<div class=\"main-content\" style=\"padding:30px 1px\">\r\n    <div class=\"container-fluid\">\r\n        <div class=\"card\">\r\n            <div class=\"card-header card-header-info\">\r\n                <h4 class=\"card-title\" style=\"text-align:center\">Inventory Transfer</h4>\r\n            </div>\r\n            <div class=\"card-body\">\r\n                <form [formGroup]=\"PackageForm\">\r\n                    <div class=\"row\">\r\n                        <div class=\"col-md-12\">\r\n                            <mat-form-field class=\"example-full-width\">\r\n                                <input matInput [formControl]=\"this.packageName\" [(ngModel)]=\"packageObj.packageName\" (keyup)=\"getPackagebasedonSearch()\"\r\n                                    autocomplete=\"off\">\r\n                                <mat-placeholder class=\"placeholder\">Package Name</mat-placeholder>\r\n                            </mat-form-field>\r\n\r\n                            <div class=\"height-skus\">\r\n                                <div *ngFor=\"let key of filteredPackageList\" (click)=\"selectPackage(key)\" style=\"background-color:white;padding: 6px;border-bottom:1px solid #ddd\">\r\n                                    {{key.packageName}} </div>\r\n                            </div>\r\n                            <span *ngIf=\"formValidate&&!packageSelection\" class=\" text-danger \">Please select package name</span>\r\n                        </div>\r\n                    </div>\r\n                    <div class=\"clearfix\"></div>\r\n                </form>\r\n                <div *ngFor=\"let sku of skuList\">\r\n                    <mat-accordion>\r\n                        <mat-expansion-panel style=\"border-left: 2px solid #26c6da;margin-bottom:8px\">\r\n                            <mat-expansion-panel-header>\r\n                                <mat-panel-title>\r\n                                    <b>{{sku.productName}}</b>\r\n                                </mat-panel-title>\r\n                            </mat-expansion-panel-header>\r\n                            <div class=\"row\">\r\n                                <div class=\"col-6\"><b>SKU : </b></div>\r\n                                <div class=\"col-6\">{{sku.skuCode}}</div>\r\n                                <div class=\"col-6\"><b>Quantity : </b></div>\r\n                                <div class=\"col-6\">{{sku.totalQuantity}}</div>\r\n                            </div>\r\n                        </mat-expansion-panel>\r\n                    </mat-accordion>\r\n                </div>\r\n                <br>\r\n                <div class=\"row\" *ngIf=\"scannedDetails\">\r\n                    <div class=\"col-6\" *ngIf=\"scannedDetails?.overalRemainingCount!=0\">\r\n                        Pending : {{scannedDetails.overalRemainingCount}}\r\n                    </div>\r\n                    <div class=\"col-6\" *ngIf=\"scannedDetails?.overalRemainingCount!=0\">\r\n                        Scanned Count : {{scannedDetails.overalScannedCount}}\r\n                    </div>\r\n                    <div class=\"col-sm-12\" *ngIf=\"scannedDetails?.overalRemainingCount==0\">\r\n                        Total Products Scanned for this package\r\n                    </div>\r\n                </div>\r\n                <div class=\"row\">\r\n                    <div class=\"col-6\">\r\n                        <button class=\"btn btn-warning\" (click)=\"goToHomePage()\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Back &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button>\r\n                    </div>\r\n                    <div class=\"col-6\" *ngIf=\"packageList.length!=0\">\r\n                        <button class=\"btn btn-primary\" (click)=\"ScanTheProduct()\" *ngIf=\"scannedDetails?.overalRemainingCount!=0\">Scan & Move</button>\r\n                    </div>\r\n                </div>\r\n                <!--<div *ngIf=\"packageList.length!=0\">\r\n                    <button class=\"btn btn-primary\" (click)=\"ScanTheProduct()\" *ngIf=\"scannedDetails?.overalRemainingCount!=0\">Scan & Move</button>\r\n                </div>\r\n                <button class=\"btn btn-warning\" (click)=\"goToHomePage()\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Back &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button>-->\r\n                <h6 style=\"text-align:center;margin-bottom:0px\" *ngIf=\"packageList.length==0\">No Packages Available for Scanning</h6>\r\n            </div>\r\n        </div>\r\n    </div>\r\n</div>"

/***/ }),

/***/ "./src/app/+product-management/shipping/shipping.component.ts":
/*!********************************************************************!*\
  !*** ./src/app/+product-management/shipping/shipping.component.ts ***!
  \********************************************************************/
/*! exports provided: ShippingProductComponent, DialogComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ShippingProductComponent", function() { return ShippingProductComponent; });
...
var ShippingProductComponent = /** @class */ (function () {
    function ShippingProductComponent(dialog, _qrScanner, _appService, _router, fb) {
        this.dialog = dialog;
    ...
    ShippingProductComponent.prototype.ngOnInit = function () {
    ...
    ShippingProductComponent.prototype.getAllPackages = function () {
        var _this = this;
        this._appService.getAllPackageDetails().subscribe(function (data) {
            if (data.error == null) {
    ...
    ShippingProductComponent.prototype.selectPackage = function (obj) {
        var _this = this;
    ...
    ShippingProductComponent.prototype.getPackagebasedonSearch = function () {
        var _this = this;
    ...
    ShippingProductComponent.prototype.ScanTheProduct = function () {
        var _this = this;
        if (this.PackageForm.valid) {
            ...
            this._qrScanner.promiseScan().then(function (result) {
                ...
                if (!_this.resultQrcode.cancelled) {
                    _this._appService.CheckingQRWithPackage(_this.resultQrcode.text, _this.packageObj.packageId, _this.facility.id).subscribe(function (data) {
                        if (data.data != null) {
                            _this.productInfo = data.data;
                            _this._appService.qrCodeMoving(_this.resultQrcode.text, _this.packageObj.packageId).subscribe(function (data) {
                                _this.openDialog('Qrcode Scanned Successfully');
    ...
    ShippingProductComponent.prototype.openDialog = function (msgText) {
        var _this = this;
        var dialogRef = this.dialog.open(DialogComponent, { disableClose: true });
        localStorage.setItem('msg', msgText);
        dialogRef.afterClosed().subscribe(function (result) {
            if (result) {
                _this.goToScanningPage();
            }
        });
    };
    ShippingProductComponent.prototype.moveToPackage = function () {
        alert('inventory moved successfully');
        this.productInfo = null;
    };
    ShippingProductComponent.prototype.goToScanningPage = function () {
        this._router.navigate(['./product/shipping']);
    };
    ShippingProductComponent.prototype.goToHomePage = function () {
        this._router.navigate(['./inventory']);
    };
    ShippingProductComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'inventory-shipping',
            template: __webpack_require__(/*! ./shipping.component.html */ "./src/app/+product-management/shipping/shipping.component.html"),
    ...
    return ShippingProductComponent;
}());
...
/*!*****************************************************************!*\
  !*** ./src/app/+product-management/shipping/shipping.module.ts ***!
  \*****************************************************************/
/*! exports provided: ShippingProductModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ShippingProductModule", function() { return ShippingProductModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm5/common.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
/* harmony import */ var _shipping_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./shipping.component */ "./src/app/+product-management/shipping/shipping.component.ts");
...
var routes = [
    {
        path: '',
        component: _shipping_component__WEBPACK_IMPORTED_MODULE_4__["ShippingProductComponent"]
    }
];
var ShippingProductModule = /** @class */ (function () {
    function ShippingProductModule() {
    }
    ShippingProductModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [_shipping_component__WEBPACK_IMPORTED_MODULE_4__["ShippingProductComponent"], _shipping_component__WEBPACK_IMPORTED_MODULE_4__["DialogComponent"]],
            providers: [],
            entryComponents: [_shipping_component__WEBPACK_IMPORTED_MODULE_4__["DialogComponent"]]
        })
    ], ShippingProductModule);
    return ShippingProductModule;
}());

...
<script type="text/javascript" src="./resources/js/filterData.js "></script>
...
<body onload="noBack()">
	...
	<div id="wrapper">
		<div id="page-wrapper" class="gray-bg">
			...
			<div>
				<div>
					<a href=".//Product checklist report by date"><button
							type="button" id="download" class="button">Download</button></a> <a
				...
				<div class="ibox float-e-margins" style="margin-bottom: 60px;">
					<div class="ibox-content">
						<div id="DataTables_Table_0_wrapper"
							...
							<br>
							<table id="filteredProductCheclists"
								...
								<tbody>
									<c:forEach var="checkList"
										items="${allCheckListData.checkLists}" varStatus="status">
										...
										<sec:authorize access="hasRole('ROLE_ACCOUNTANT')">
											...
											<tr class="status">
												...
												</a> <c:if test="${checkList.status==1}">
														<a title="verified"> <img
															src="<%=request.getContextPath()%>/resources/images/verify.png"></img></a>
													</c:if> <c:if test="${checkList.status==2}">
														<a style="margin-right: 6px" title="Approved"> <img

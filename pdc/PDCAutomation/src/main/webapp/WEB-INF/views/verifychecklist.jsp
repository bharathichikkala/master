...
<script type="text/javascript" src="./resources/js/verifychecklist.js"></script>
			...
			<div class="row wrapper border-bottom white-bg page-heading">
				<div class="col-lg-10">
					...
					<ol class="breadcrumb">
						...
						<li class="active"><strong>Verify ProductCheckList</strong></li>
					</ol>
				</div>
						...
						<form class="well form-horizontal" method="post" id="contact_form">
							...
							<div class="scroll">
								<div class="form-group">
									<label class="col-md-4 control-label">OrderId</label>
								...
								<div class="form-group">
									<label class="col-md-4 control-label">DocketNumber</label>
									<div class="col-md-4 inputGroupContainer">
										<div class="input-group">
											<span class="input-group-addon"><i
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<input type="button" class="btn btn-warning"
											id="verifychecklist_submit" value="Save"> <span

...
@Component({
 ...
 .btn-primary[disabled]:hover {
     background-color:red !imporrtant;
    }
...
export class DateFilterComponent {
    ...
    { id: 2, range: 'lastmonth', name: 'Last Month' }, { id: 3, range: 'thismonth', name: 'This Month (MTD)' },
    { id: 4, range: 'last7days', name: 'Last 7 Days' }, { id: 5, range: 'last30days', name: 'Last 30 Days' },
    { id: 6, range: 'last60days', name: 'Last 60 Days' }, { id: 7, range: 'last90days', name: 'Last 90 Days' },
    ...
    date = new Date()
    constructor(private dateFilterService: DateDataFilterService) {
    }
        ...
        this.dateFilterService.getLocationDetails().subscribe(
            (data: any) => {
                if (data.error === null) {
                    ...
                    let banjaraLocationDetails = this.locationDetailsData.find(location => "BHSHW" === location.locationCode)
                    this.locationId = banjaraLocationDetails.id;
                    this.QueryDataDate.locationId = this.locationId;
                    this.dateDetails()
                    this.dateData.emit(this.QueryDataDate)

...
import com.mss.pmj.pmjmis.svcs.TagPricetoSalesD2hServiceStateandCluster;

@RestController
public class TagPricetoSalesD2hServiceStateandClusterImpl implements TagPricetoSalesD2hServiceStateandCluster {

	private static Logger log = LoggerFactory.getLogger(TagPricetoSalesD2hServiceStateandClusterImpl.class);
	...
	public TagpricetoSalesResponse<TagpricetoSalesDataD2HState> getTagpricetoSalesByMonth(String state,
			String startDate, String endDate) {
		log.info("Tag Price to Sales Implementation by Month");

		TagpricetoSalesResponse<TagpricetoSalesDataD2HState> tagpricetoSalesDataD2HState = new TagpricetoSalesResponse<>();

		TagpricetoSalesDataD2HState states = new TagpricetoSalesDataD2HState();

		TagPricetoSalesD2HClusters tagpricetosalesd2h = new TagPricetoSalesD2HClusters();

		TagPricetoSalesDetailsD2hcluster tagpricetosalesdetailsd2h = new TagPricetoSalesDetailsD2hcluster();
		...
		try {
			...
			states.setTotaltagprice(totalTagPrice);
			...
			states.setD2hdetails(tagpricetosalesdetailsd2h);
			states.setSaleprice(salePrice1);
			states.setTagprice(tagPrice1);

			tagpricetoSalesDataD2HState.setStatus(HttpServletResponse.SC_OK);
			tagpricetoSalesDataD2HState.setMessage("tag d2h month successful");
			tagpricetoSalesDataD2HState.setFromDate(startDate);
			tagpricetoSalesDataD2HState.setToDate(endDate);
			tagpricetoSalesDataD2HState.setData(states);

		} catch (Exception e) {
			log.info("state");
		}
		return tagpricetoSalesDataD2HState;
	}

	public TagpricetoSalesResponse<TagpricetoSalesDataD2HState> getTagpricetoSalesByDay(String state, String startDate,
			String endDate) {
		...
		try {
			...
			tagpricetoSalesDataD2HState.setStatus(HttpServletResponse.SC_OK);
			tagpricetoSalesDataD2HState.setMessage("tag d2h day successful");
			tagpricetoSalesDataD2HState.setFromDate(startDate);
			tagpricetoSalesDataD2HState.setToDate(endDate);
	...
	public TagpricetoSalesResponse<TagpricetoSalesDataD2HState> getTagpricetoSalesByWeek(String state, String startDate,
			String endDate) {
		log.info("Tag Price to Sales Implementation");
		...
		try {
			...
			tagpricetoSalesDataD2HState.setStatus(HttpServletResponse.SC_OK);
			tagpricetoSalesDataD2HState.setMessage("tag d2h week successful");
			tagpricetoSalesDataD2HState.setFromDate(startDate);
			tagpricetoSalesDataD2HState.setToDate(endDate);
	...
	@Override
	public TagpricetoSalesResponse<TagpricetoSalesDataD2HState> getTagpricetoSales(String state, String startDate,
			String endDate) {
		...
		try {
			...
			if (betweenDays < 15) {
				// daywise
				tagpricetoSalesDataD2HState = getTagpricetoSalesByDay(state, startDate, endDate);
			} else if (betweenDays >= 15 && betweenDays <= 60) {
				// week wise
				tagpricetoSalesDataD2HState = getTagpricetoSalesByWeek(state, startDate, endDate);
			} else {
				// month wise
				tagpricetoSalesDataD2HState = getTagpricetoSalesByMonth(state, startDate, endDate);
			}
		} catch (Exception e) {
			tagpricetoSalesDataD2HState.setError(EnumTypeForErrorCodes.SCUS105.name(),
					EnumTypeForErrorCodes.SCUS105.errorMsg());
			tagpricetoSalesDataD2HState.setMessage("Failed to get TagPrice to Sales Margins");
			log.error(utils.toJson(tagpricetoSalesDataD2HState.getError()), e);
		}
		return tagpricetoSalesDataD2HState;
	}

...
import com.mss.pmj.pmjmis.svcs.CosttoSalesD2hServiceStateandCluster;

@RestController
public class CosttoSalesD2hServiceStateandClusterImpl implements CosttoSalesD2hServiceStateandCluster {

	private static Logger log = LoggerFactory.getLogger(CosttoSalesD2hServiceStateandClusterImpl.class);
	...
	public CostpricetoSalesResponse<CostPricetoSalesDataD2hStateandCluster> getCostpricetoSalesd2hclusterByMonth(
			String state, String cluster, String startDate, String endDate) {
		log.info("Cost Price to Sales Implementation by Month");

		CostpricetoSalesResponse<CostPricetoSalesDataD2hStateandCluster> costPricetoSalesDataD2hStateandCluster = new CostpricetoSalesResponse<>();

		CostPricetoSalesDataD2hStateandCluster clusters = new CostPricetoSalesDataD2hStateandCluster();
		...
		try {
			...
			clusters.setTotalcostprice(totalcostPrice);
			...
			clusters.setD2hdetails(costpricetosalesdetailsd2h);
			clusters.setSaleprice(salePrice1);
			clusters.setCostprice(costPrice1);

			costPricetoSalesDataD2hStateandCluster.setStatus(HttpServletResponse.SC_OK);
			costPricetoSalesDataD2hStateandCluster.setMessage("Cost d2h month successful");
			costPricetoSalesDataD2hStateandCluster.setFromDate(startDate);
			costPricetoSalesDataD2hStateandCluster.setToDate(endDate);
			costPricetoSalesDataD2hStateandCluster.setData(clusters);

		} catch (Exception e) {
			log.info("state name");
		}
		return costPricetoSalesDataD2hStateandCluster;
	}

	public CostpricetoSalesResponse<CostPricetoSalesDataD2hStateandCluster> getCostpricetoSalesd2hclusterByDay(
			String state, String cluster, String startDate, String endDate) {
		...
		try {
			...
			clusters.setTotalcostprice(totalCostPrice1);
			clusters.setState(state);
			clusters.setCluster(cluster);
			...
			costPricetoSalesDataD2hStateandCluster.setStatus(HttpServletResponse.SC_OK);
			costPricetoSalesDataD2hStateandCluster.setMessage("Cost d2h day successful");
			costPricetoSalesDataD2hStateandCluster.setFromDate(startDate);
			costPricetoSalesDataD2hStateandCluster.setToDate(endDate);
			costPricetoSalesDataD2hStateandCluster.setData(clusters);
	...
	public CostpricetoSalesResponse<CostPricetoSalesDataD2hStateandCluster> getCostpricetoSalesd2hclusterByWeek(
			String state, String cluster, String startDate, String endDate) {
		log.info("Cost Price to Sales Implementation");
		...
		try {
			...
			costPricetoSalesDataD2hStateandCluster.setStatus(HttpServletResponse.SC_OK);
			costPricetoSalesDataD2hStateandCluster.setMessage("Cost d2h week successful");
			costPricetoSalesDataD2hStateandCluster.setFromDate(startDate);
			costPricetoSalesDataD2hStateandCluster.setToDate(endDate);
			costPricetoSalesDataD2hStateandCluster.setData(clusters);
	...
	@Override
	public CostpricetoSalesResponse<CostPricetoSalesDataD2hStateandCluster> getCostpricetoSalesd2hcluster(String state,
		...
		try {
			...
			if (betweenDays < 15) {
				// daywise
				costPricetoSalesDataD2hStateandCluster = getCostpricetoSalesd2hclusterByDay(state, cluster, startDate,
						endDate);
			} else if (betweenDays >= 15 && betweenDays <= 60) {
				// week wise
				costPricetoSalesDataD2hStateandCluster = getCostpricetoSalesd2hclusterByWeek(state, cluster, startDate,
						endDate);
			} else {
				// month wise
				costPricetoSalesDataD2hStateandCluster = getCostpricetoSalesd2hclusterByMonth(state, cluster, startDate,
						endDate);
			}
		} catch (Exception e) {
			costPricetoSalesDataD2hStateandCluster.setError(EnumTypeForErrorCodes.SCUS110.name(),
					EnumTypeForErrorCodes.SCUS110.errorMsg());
			costPricetoSalesDataD2hStateandCluster.setMessage("Failed to get costPrice to Sales Margins");
			log.error(utils.toJson(costPricetoSalesDataD2hStateandCluster.getError()), e);
		}
		return costPricetoSalesDataD2hStateandCluster;
	}
